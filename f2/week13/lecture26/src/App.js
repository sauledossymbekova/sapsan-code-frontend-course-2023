...
function App() {
  ...
  // console.log(filteredList, "мужские вещи")
  const womenProducts = data.filter(
    (product) => product.category === "women's clothing"
  );
  // console.log(womenProducts, "женские вещи")
  const cheapProducts = data.filter((product) => product.price < 50 && product.category === "women's clothing");
